...
using static StupidTemplate.Menu.Themes;
    ...
    public class Buttons
    {
        ...
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Menu Theme:", overlapText = "Menu Theme: Cryptic", method =() => ChangeMenuTheme(), isTogglable = false, toolTip = "Changes the menu theme."},
            ...
            new ButtonInfo[] { // Movement [5]
                ...
                new ButtonInfo { buttonText = "Speedboost", method =() => Movement.Speedboost(), toolTip = "Gives the player a slight speedboost."},
            ...
            new ButtonInfo[] { // Placeholder DO NOT CHANGE
                new ButtonInfo { buttonText = "Return to Main", method =() => currentCategory = 0, isTogglable = false, toolTip = "Returns to the main page of the menu."},
            },
        };
    }
