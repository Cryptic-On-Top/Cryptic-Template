...
namespace StupidTemplate
{
    public class Settings
    {
        ...
        public static ExtGradient backgroundColor = new ExtGradient { colors = ExtGradient.GetSolidGradient(new Color32(35, 35, 35, 255)) };
        public static ExtGradient[] buttonColors = new ExtGradient[]
        {
            Themes.buttonColors[0], // Disabled
            Themes.buttonColors[1] // Enabled
        };
        ...
        public static float bevelSize = 0.05f;
        public static bool shouldRound;

        public static KeyCode keyboardButton = KeyCode.Q;

        public static Vector3 menuSize = new Vector3(0.01f, 1f, 1f); // Depth, width, height
        public static int buttonsPerPage = 7;

        public static float gradientSpeed = 0.2f; // Speed of colors
    }
}
