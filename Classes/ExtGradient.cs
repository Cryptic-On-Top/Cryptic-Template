...
namespace StupidTemplate.Classes
{
    public class ExtGradient
    {
        ...
        public static GradientColorKey[] GetThreeGradient(Color a, Color b, Color c) =>
            new GradientColorKey[] { new GradientColorKey(a, 0f), new GradientColorKey(b, 0.4f), new GradientColorKey(c, 0.7f), new GradientColorKey(a, 1f) };
