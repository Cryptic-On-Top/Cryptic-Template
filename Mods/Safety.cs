...
using static StupidTemplate.Notifications.NotifiLib;
    ...
    public class Safety
    {
        ...
        public static void AntiReportDisconnect()
        {
            AntiReport((vrrig, position) =>
            {
                ...
                NotifiLib.SendNotification("<color=grey>[</color><color=purple>ANTI-REPORT</color><color=grey>]</color> " + " " + "[you have been disconnected]");
            });
        }
    }
}
